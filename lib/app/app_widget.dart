...
class _AppWidgetState extends State<AppWidget> {
  ...
  final sqliteAdmConnection = SqliteAdmConnection(); // pega o singleton do sqlite connection para abrir e fechar a conexão de acordo com o estado atual da aplicação
